#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# @Date    : Jan-04-22 23:15
# @Author  : Kan HUANG (kan.huang@connect.ust.hk)
# @RefLink : https://github.com/tensorflow/tensorflow/blob/v1.15.0/tensorflow/python/keras/datasets/cifar10.py#L31-L70
# @RefLink : https://github.com/openai/glow/blob/master/data_loaders/get_mnist_cifar.py
...
def get_data(problem, data_augmentation_level, n_batch_train, n_batch_test, n_batch_init, resolution):
    if problem == 'mnist':
        ...
        y_train = np.reshape(y_train, [-1])  # (50000, 1) -> (50000,)
        y_test = np.reshape(y_test, [-1])  # (10000, 1) -> (10000,)
    else:
        raise Exception()
